...
class DlgVarConfig(wx.Dialog):
    ...
    def on_btn_var_dets_path(self, unused_event):
        ...
        dlg_get_file = wx.FileDialog(
            ...
            defaultDir=str(mg.LOCAL_PATH / mg.VDTS_FOLDER),
    ...
    def on_btn_script_path(self, unused_event):
        ...
        dlg_get_file = wx.FileDialog(self, 
            ...
            defaultDir=str(mg.LOCAL_PATH / mg.SCRIPTS_FOLDER),
...
class ConfigUI:
    ...
    def get_dp_spinner(self, panel, dp_val):
        """
        Merely changes the default dp in config so anything subsequently
        referring to it gets a different value. Nothing directly happens.
        """
    ...
    def on_btn_report_path(self, _event):
        ...
        dlg_get_file = wx.FileDialog(self,
            ...
            defaultDir=str(mg.REPORTS_PATH), defaultFile='',
    ...
    def on_report_file_lost_focus(self, evt):
